...
export default function TeacherLoginPage() {
  ...
  const [step, setStep] = useState<'code' | 'oauth'>('code');
  ...
  const handleCodeSubmit = (e: React.FormEvent) => {
    ...
    // Store the code temporarily and move to OAuth step
    sessionStorage.setItem('pendingTeacherCode', code);
    setStep('oauth');
    handleGoogleSignIn();
  };
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // If successful, OAuth flow will redirect to /auth/callback
    } catch (err: any) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-5 sm:p-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
            Sign in with your Google account and enter your teacher code
          </p>
          ...
          {step === 'code' ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">Complete the Google sign-in...</p>
              <button
                onClick={() => {
                  setStep('code');
                  setLoading(false);
