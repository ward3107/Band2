...
export default function HomePage() {
  ...
  const [studentView, setStudentView] = useState<'join' | 'signin'>('join');
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-5xl">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-5 sm:p-8 flex flex-col">
          ...
          {role === 'teacher' ? (
            ...
            /* ── Student: SIGN IN with email/password (secondary view) ── */
            <>
              <div className="flex items-center gap-3 mb-5">
                <span className="text-4xl">🎓</span>
              ...
              <div className="mt-4 flex flex-col items-center gap-2 text-sm">
                ...
                <button onClick={() => { setStudentView('join'); setError(''); }} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 text-xs">
